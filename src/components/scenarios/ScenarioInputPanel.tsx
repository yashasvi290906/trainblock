...
export function ScenarioInputPanel({
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between space-y-4 shadow-sm h-full">
      ...
      <div className="space-y-2">
          ...
          <div className="space-y-3 font-sans text-xs">
            <div className="p-3 bg-slate-950/80 rounded-lg border border-slate-800 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono text-slate-400">Current Possession:</span>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1 border-t border-slate-800/80 text-[11px] font-mono">
                <div>
                  ...
                  <span className="text-white font-bold">{BASELINE_PLAN.totalWorkOrders} (3 P1, 7 P2)</span>
                </div>
                <div>
                  <span className="text-slate-400">Usable Time:</span>{" "}
                  <span className="text-emerald-400 font-bold">{BASELINE_PLAN.usableWorkMin} min</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-3 bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold text-xs rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all"
            >
          ...
          <div className="space-y-3 text-xs">
            ...
            {scenarioState === "IDLE" ? (
              <div className="p-3 bg-slate-950/80 rounded-lg border border-slate-800 space-y-2.5">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-slate-300">Base Request:</span>
                ...
                <button
                  onClick={onSimulateDenial}
                  className="w-full py-2 px-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono font-bold text-xs rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all"
                >
              ...
              <div className="p-3 bg-rose-950/30 border border-rose-600/40 rounded-lg space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-rose-300 font-bold flex items-center gap-1.5">
                    <XCircle className="w-4 h-4 text-rose-400" />
                    OPERATING RESPONSE
                  </span>
                  <span className="px-2 py-0.5 rounded bg-rose-900/60 text-rose-200 text-[10px] font-mono font-bold border border-rose-700/50">
                    DENIED
                  </span>
                </div>
                <p className="text-[11px] text-rose-200/90 leading-snug">
                  “Requested possession <span className="font-mono font-bold text-white">B-014 (02:20–04:10)</span> unavailable in current window. High-density corridor traffic.”
                </p>
              </div>
            )}
            ...
            {scenarioState !== "IDLE" && (
              <div className="space-y-2 pt-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-slate-400">Select candidate</span>
                </div>
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          isSelected
                            ? "bg-blue-950/70 border-blue-400 shadow-sm"
                            : "bg-slate-950/70 border-slate-800 hover:border-slate-700 text-slate-300"
                        )}
                      >
                        <div className="flex items-center justify-between font-mono">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-white">{fw.code}</span>
                            <span className="text-blue-400 font-semibold">{fw.startTime}–{fw.endTime}</span>
                          </div>
                          <span
                            className={cn(
                        ...
                        <div className="grid grid-cols-2 gap-1 text-[11px] font-mono text-slate-400">
                          <div>
                            ...
                            <span className={fw.passengerConflicts === 0 ? "text-emerald-400 font-bold" : "text-amber-400 font-bold"}>
                              {fw.passengerConflicts}
                            </span>
                          </div>
                          <div>
                            <span>Available work time:</span>{" "}
                            <span className="text-white font-bold">{fw.usableWorkMin} min</span>
                          </div>
                        </div>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-2.5 px-3 bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold text-xs rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all disabled:opacity-60"
                  >
                    {isReplanning ? (
          ...
          <div className="space-y-3 text-xs">
            <div className="p-2.5 bg-slate-950/80 rounded-lg border border-slate-800 space-y-2">
              ...
              <div className="space-y-2 font-mono text-[11px]">
                <div>
                  <label className="text-slate-400 text-[10px] block mb-0.5">Department</label>
                  <select
                    ...
                    className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-1 text-white text-xs focus:outline-hidden focus:border-blue-400"
                  >
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    <label className="text-slate-400 text-[10px] block mb-0.5">Location</label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      <input
                        ...
                        className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-1 text-white text-xs focus:outline-hidden focus:border-blue-400 font-mono"
                      />
                      <span className="text-slate-400 text-xs">min</span>
                    </div>
                  </div>
                  <div>
                    <label className="text-slate-400 text-[10px] block mb-0.5">Criticality</label>
                    <select
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-1 text-rose-300 font-bold text-xs focus:outline-hidden focus:border-blue-400"
                    >
            ...
            {scenarioState === "INSUFFICIENT_WINDOW" && (
              <div className="p-2.5 bg-amber-950/40 border border-amber-600/40 rounded-lg space-y-1.5 font-mono">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-slate-400">BASELINE:</span>
                  <span className="text-white">18 orders • 90 min usable</span>
                </div>
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-amber-400 font-bold">SCENARIO:</span>
                  <span className="text-amber-300 font-bold">19 orders • 135 min required</span>
                </div>
                <div className="p-1.5 rounded bg-rose-950/60 border border-rose-700/50 text-rose-200 text-[10px] leading-snug mt-1">
                  <span className="font-bold text-rose-300">STATUS: INSUFFICIENT WINDOW</span>
                  <br />
        ...
        {condition === "TRAIN_MOVEMENT" && (
          <div className="space-y-3 text-xs">
            <div className="p-2.5 bg-slate-950/80 rounded-lg border border-slate-800 space-y-2">
              ...
              <div className="space-y-2 font-mono text-[11px]">
                <div>
                  <label className="text-slate-400 text-[10px] block mb-0.5">Select Train Movement</label>
                  <select
                ...
                <div className="p-2 bg-slate-900 rounded border border-slate-800 space-y-1">
                  <div className="flex justify-between text-[10px] text-slate-400">
                    ...
                    <span className="text-white font-bold">{selectedTrain.baseKm72Time}</span>
                  </div>
            ...
            {scenarioState === "CONFLICT_DETECTED" && (
              <div className="p-2.5 bg-amber-950/40 border border-amber-600/40 rounded-lg space-y-1 font-mono text-[11px]">
                ...
                <div className="text-[10px] text-emerald-400 font-bold pt-1 border-t border-slate-800">
        ...
        {condition === "BLOCK_DURATION" && (
          <div className="space-y-3 text-xs">
            <div className="p-2.5 bg-slate-950/80 rounded-lg border border-slate-800 space-y-2.5">
              <span className="text-[10px] font-mono font-bold text-blue-400 uppercase tracking-wider block">
                BLOCK DURATION ADJUSTMENT
              </span>

              <div className="space-y-1.5 font-mono">
                <label className="text-slate-400 text-[10px] block">Select Window Variation</label>
              ...
              <div className="p-2 bg-slate-900 rounded border border-slate-800 space-y-1.5 font-mono text-[11px]">
                <div className="flex justify-between">
                  <span className="text-slate-400">Total Possession:</span>
                  <span className="text-white font-bold">{110 + durationOffsetMin} min</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Usable Work Time:</span>
                  <span className="text-emerald-400 font-bold">{90 + durationOffsetMin} min</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Traffic Exposure:</span>
                  <span className={durationOffsetMin > 10 ? "text-amber-400 font-bold" : "text-emerald-400 font-bold"}>
        ...
        {isReplanning && (
          <div className="p-2.5 bg-blue-950/40 border border-blue-700/50 rounded-lg space-y-1.5 animate-fadeIn font-mono">
              ...
              {REPLAN_CHECKLIST.map((step, idx) => (
                <div
                  ...
                  className={cn(
                    ...
                    replanStep === idx
                      ? "bg-blue-600/30 text-white font-bold border border-blue-500/50 animate-pulse"
                      : replanStep > idx
                ...
                >
                  {replanStep > idx ? (
                    ...
                    <span className="w-3 h-3 rounded-full bg-slate-800 text-[8px] flex items-center justify-center text-slate-400 flex-shrink-0">
                      {idx + 1}
                    </span>
                  )}
                  <span>{step}</span>
      ...
      <div className="pt-2 border-t border-slate-800 text-[10px] font-mono text-slate-400 flex items-center justify-between">
        ...
        <span className="text-slate-500">BDMS / FOIS Rule Set</span>
      </div>
    </div>
  );
}
